...
\begin{tikzpicture}
  ...
  \visible<3->{
    \tznode* [color3] (\rocqWidth/2,2*\zooVsep) {Std}
  }
  
  \visible<5->{
    \tznode* [color3] (\rocqWidth/2-3,2*\zooVsep) {Persistent}
  }
  
  \visible<7->{
    \tznode* [color3] (\rocqWidth/2+3,2*\zooVsep) {Rcfd}
  }
  
  \visible<9->{
    \tznode* [color3] (\rocqWidth/2-1.5,4*\zooVsep) {Saturn}
  }
  
  \visible<11->{
    \tznode* [color3] (\rocqWidth/2+1.5,4*\zooVsep) {Kcas}
  }
  
  \visible<13->{
    \tznode* [color3] (\rocqWidth/2,6*\zooVsep) {Parabs}
  }
\end{tikzpicture}
