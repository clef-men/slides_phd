...
\Large
\textbf{\Iris-based verification frameworks can scale to real-life programming languages and (relatively) large pieces of software.}
\vfill
\begin{itemize}
...
\begin{overbox}<2>[width=.95]
  ...
  \begin{itemize}
    ...
    \item Ongoing work on (parts of) the \OCaml GC.
  \end{itemize}
\end{overbox}
\end{frame}
